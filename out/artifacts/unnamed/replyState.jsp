    ...
    <div class="col-xs-3 col-md-2" style="width: 220px" >
        ...
        <%--</div>--%>
            ...
            <div class="col-xs-10 col-md-10">
                    ...
                    <h2>回复审核</h2>
                <form class="form-signin" id="replyState" action="replyState2" method="post">
                    ...
                    <table style="text-align: center" width="100%"  class="table table-striped table-bordered">
                        ...
                        <tr>
                            <td>回复人</td>
                            <td>
                                <label for="replier" class="sr-only">回复人</label>
                                <input disabled style="width: 300px;height: 40px" id="replier" type="text" value="${message.replier }" name="replier" class="form-control" placeholder="回复人" required autofocus>
                            </td>
                        </tr>
                        <tr>
                            <td>回复内容</td>
                            <td>
                                ...
                                <input style="width: 600px;height: 100px" type="hidden" id="theReply" value="${message.reply }" class="form-control" placeholder="回复内容" required autofocus>
                                <textarea disabled id="reply" name="reply" rows="10" type="text" cols="80"  class="form-control" placeholder="回复内容" required autofocus></textarea>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <input class="btn btn-info" type="submit" name="state" value="审核通过">
                                <input class="btn btn-info" type="submit" name="state" value="审核未通过">
                            </td>
                        </tr>
                    </table>
                </form>
                    <%--<script type="text/javascript">--%>
                        <%--function replyStateY() {--%>
                            <%--//回复通过--%>
                            <%--document.getElementById("replyState").submit();--%>
                        <%--}--%>
                        <%--function replyStateN() {--%>
                            <%--//回复未通过--%>
                            <%----%>
                        <%--}--%>
                    <%--</script>--%>
                <%--<input type="submit" style="height: 40px;width: 100px" class="btn btn-info" name="state" onclick="replyStateY()" value="回复通过">--%>
                <%--<input type="submit" style="height: 40px;width: 100px" class="btn btn-info" name="state" onclick="replyStateN()" value="回复未通过">--%>
