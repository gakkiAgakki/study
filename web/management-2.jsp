...
<div class="row" style="width: 1400px">
    <div class="col-xs-3 col-md-2" style="width: 220px" >
        <%--<div style="z-index: 9999; position: fixed ! important; left: 0px; top: 0;">--%>
            ...
            <div class="row" style="height: 80px">
                <div class="col-xs-8 col-sm-6 col-xs-offset-3">
                    <input  class="btn btn-primary" style="width: 120px;height: 40px" type="button" value="删除选中留言" onclick="delMsgs()">
                </div>
            </div>
        <%--</div>--%>
    </div>
            ...
            <table style="text-align: center;width: 1800px;" class="table table-striped table-bordered" align="center">
                ...
                <c:forEach var="msg" items="${pb.pList}" >
                    <tr>
                        ...
                        <td>${msg.unit }</td>
                        <td>${msg.site }</td>
                        <td><input value="${msg.content }" disabled></td>
                        <%--<td>${msg.reply}</td>--%>
                        <td><input value="${msg.reply}" disabled></td>
                    ...
                    <table class="table table-striped table-bordered" align="center">
                        <tr align="center">
                            <td>
                                <a <c:if test="${pb.pageNum > 1 }"> href="${pageContext.request.contextPath }/findByCateServlet?pageNum=${pb.pageNum - 1}"</c:if>>上一页</a>

                                <c:forEach var="current" begin="1" end="${pb.pages }" >
                                    <a href="${pageContext.request.contextPath }/findByCateServlet?pageNum=${current}">${current }</a>
                                </c:forEach>

                                <a <c:if test="${pb.pageNum < pb.pages }"> href="${pageContext.request.contextPath }/findByCateServlet?pageNum=${pb.pageNum + 1}"</c:if>>下一页</a>
